        ...
        <div className="lg:w-1/2 p-6 md:p-10 lg:p-12 border-b lg:border-b-0 lg:border-r border-white/15 bg-black/40 flex flex-col justify-center gap-6">
          ...
          <div className="border-l-2 border-white/20 pl-5 py-1 flex flex-col gap-4 font-body">
            <p className="text-white/90 text-[1.05rem] leading-relaxed max-w-[680px]">
              Step into a <span className="text-cyan-300 font-semibold">cozy fantasy province</span> where players become residents, build their legacy, and solve evolving town problems. Travel between delightful <span className="text-pink-300 font-semibold">confectionery towns</span>, interact and travel along with <span className="text-pink-300 font-semibold">lovely and unforgettable characters</span>, and unlock rich, story-driven rewards.
            </p>
            <p className="text-white/90 text-[1.05rem] leading-relaxed max-w-[680px]">
              Support vital <span className="text-orange-300 font-semibold">community projects</span>, gather unique stamps in your passport, and earn prestigious badges. The choices you make today shape the province, write tomorrow's headlines, and define your <span className="text-yellow-300 font-semibold">lasting deeds</span>.
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5 font-body">
              ...
              <div className="pt-2 space-y-2.5">
                <GlassButton
                  label={authLoading ? 'LOADING...' : (isRegistering ? 'REGISTER' : 'ENTER CHOCOBROOK')}
                  type="submit"
                  variant="primary"
                  className="!w-[70%] !mx-auto !h-14 !min-h-14 !rounded-lg !py-0"
