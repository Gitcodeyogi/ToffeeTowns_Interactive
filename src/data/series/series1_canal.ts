...
export const CANAL_SERIES: CanalSeriesStep[] = [
  ...
  // ─── STEP 1 ───────────────────────────────────────────────
  {
    ...
    headline: 'BAKER MORTIMER’S HONEYBERRY LOAF STOLEN FROM THE WINDOW SILL — PIPKIN NUTTERBY FLEES',
    storyContext:
    ...
    imageAspect: '3/2',
    professionals: [
      'Baker Mortimer · Master Baker',
      'Rowan Thistle · Volunteer Coordinator',
      'Julie Frost · Broadcaster',
    ],
    playerAssignment: {
    ...
    rowanNote:
      "Mortimer spent three hours making that glaze. We have to recover it before Pipkin eats the evidence!",
    julieNote:
      "I'm writing up a front-page piece for the Gazette. Your resident survey results will be featured in the broadsheet!",
  },
  ...
  // ─── STEP 2 ───────────────────────────────────────────────
  {
    ...
    storyContext:
      'Search volunteers cornered Pipkin in the high branch canopy. Instead of surrendering, Pipkin whistled and mobilized a troop of hyperactive squirrels who began pelting the volunteers with hard cocoa pods! Plumber Tiber Reedwell has called for immediate tactical decisions to bypass the squirrel barrage.',
    imagePath: '/Assets/Ganache Grove/Story_Series1/Scene_02.png',
    imageAspect: '3/2',
    professionals: [
      'Tiber Reedwell · Plumber',
    ...
    playerAssignment: {
      ...
      options: [
        { icon: '🪵', label: 'Offer Sweet Acorns to pacify the squirrels', xpSkill: 'builder' },
  ...
  // ─── STEP 3 ───────────────────────────────────────────────
  {
    ...
    storyContext:
      'While the team was distracted by the squirrels, Pipkin slipped away across the slippery elevated mossway bridges. He is heading towards the central water sluice gates. Tiber Reedwell and Mrs. Petalworth have prepared safety nets and need you to coordinate intercept spots.',
    imagePath: '/Assets/Ganache Grove/Story_Series1/Scene_03.png',
    imageAspect: '3/2',
    professionals: [
      'Tiber Reedwell · Engineering Safety',
      'Mrs. Petalworth · Landscape Coordinator',
      'Rowan Thistle · Community Coordinator',
    ],
    playerAssignment: {
      ...
      options: [
        ...
        { icon: '📏', label: 'Track footprints with Mrs. Petalworth', xpSkill: 'explorer' },
      ],
    },
    ...
    julieNote:
      "I've sent a camera runner to the sluice gate bridge. We'll get a clear shot of the final confrontation!",
  },
  ...
  // ─── STEP 4 ───────────────────────────────────────────────
  {
    ...
    playerAssignment: {
      ...
      description:
        'Evaluate the root hollow conditions and help Mortimer set up a healing cream sharing station for the sprites.',
      options: [
        { icon: '🪓', label: 'Use Crumblewise\'s tools to clear root debris', xpSkill: 'builder' },
  ...
  // ─── STEP 5 ───────────────────────────────────────────────
  {
    ...
    storyContext:
      'To celebrate the healing of the forest sprites, Mayor Maple Truffle hosted a special Honeyberry Feast in the town square. Baker Mortimer baked a giant communal loaf, and Pipkin was officially named the "Accidental Hero of the Week". The town is filled with joy, music, and the sweet aroma of honeyberries!',
    imagePath: '/Assets/Ganache Grove/Story_Series1/Pipkin_Nutterby.png',
    imageAspect: '3/2',
    professionals: [
      'Mayor Maple Truffle · Ribbon Cutter',
      'Baker Mortimer · Master Baker',
      'Julie Frost · Broadcaster',
    ],
    playerAssignment: {
      ...
      description:
        'The Mayor has signed your certificate of volunteer services. Collect your Honeyberry Hero badge and complete your Series 1 training.',
